...
class SharedFile(BaseModel):
    ...
    class Config:
        schema_extra = {
            "examples": [
                {
                    "file_path":  "\\\\aether\\users\\tiamp\\SEWP\\021624-DOI;U.S. Geological Survey-BMC Remedy Licenses and Maintenance-298754\\Purchasing\\RE_ DLT Opp# SEWP RFQ 298754 - Due 2_16 at noon.msg"
                },
...
async def upload_files(jobid: str = Form(...), file: UploadFile = File(...)):
    ...
    pathname = os.path.join('jobs',jobid,file.filename)
