...
# License: GNU GPLv3  from https://github.com/MichaelSebero/PrivateGPT4Linux

git clone https://github.com/imartinez/privateGPT && cd /home/$USER/privateGPT && pip install -r requirements.txt --break-system-packages --user && su -c '
